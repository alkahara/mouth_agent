...
class ChatClient:
    ...
    def __init__(self, base_url: str = "http://127.0.0.1:8000", api_key: str = "lg-disney-key-12345"):
    ...
    def simple_chat(self, content: str, user: str = "9999", **kwargs) -> Tuple[Optional[Dict[str, Any]], float]:
        """Simple chat with a single user message"""
        messages = [{"role": "user", "content": content}]
        return self.chat_completion(messages=messages, user=user, **kwargs)
...
def main():
    ...
    # response, elapsed_time = client.simple_chat("迪士尼的营业时间是什么时候")
